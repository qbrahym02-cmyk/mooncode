...
// v4.2: Initialize PluginLoader and pass to runner.
let pluginLoader = null;
try {
  const { PluginLoader } = await import("../../packages/plugin/src/index.js");
  pluginLoader = new PluginLoader();
} catch (error) {
  console.warn("[mooncode] PluginLoader not available:", error.message);
}
...
const runner = new AgentRunner({
  ...
  searchIndex,
  todoList,
  pluginLoader, // v4.2: Plugin SDK hooks
});
